...
public class StatisticsFragmentFourWeeks extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.statistics_fragment_fourweeks, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
            ...
            chart = getView().findViewById(R.id.fourweeks_chart);
    ...
    private List<PieEntry> GeneratePieEntryData(){
        ...
        LocalDateTime _fourWeeksAgo = LocalDateTime.now().minusWeeks(4L);
